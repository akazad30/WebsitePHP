    ...
    <div class="container">
        <div class="row" style="margin-bottom: 40px;margin-top: 30px;">
            ...
            <div style="margin-left: 2px;" class="demo-gallery">
                <?php
                $location='pages/uploads/gallery/cultural-program/';
                ...
                <ul id="lightgallery" class="list-unstyled row">
                    <?php
                    for($i=0;$i<$count;$i++) {
                        echo '<a class="col-md-3 col-sm-6" href="pages/uploads/gallery/cultural-program/gallery-img'.$i.'.jpg'.'">
                        <img style="margin-bottom:5px;width:98%;height: 200px; box-shadow: #666 1px 1px 3px; padding: 5px;" src="pages/uploads/gallery/cultural-program/gallery-img'.$i.'.jpg'.'" />
                    </a>';}?>
                </ul>
            </div>
        </div>
