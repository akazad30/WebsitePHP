...
if(isset($_GET['semester'])){
    ...
    $select = "SELECT * FROM students where semester='$semester'";
                            ...
                            <div class="dataTable_wrapper table-responsive">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        ?>
                                        <tr >
                                            <td align="center"><?php echo $id_no   ?></td>
                                            <td align="center"><?php echo $name   ?></td>
                                            <td align="center"><a href="student-profile-view.php?id=<?php echo $id ?>"><button id="btn3" class="view_pro btn btn-default">View</button></a></td>
                                            <?php if($_SESSION['email']==$email){?>
                                                <td align="center"><a href="student-profile-update.php?id=<?php echo $id ?>"><button name="update" id="btn3" class="view_pro btn btn-default">Update</button></a>
                                           <?php }else{ ?>
