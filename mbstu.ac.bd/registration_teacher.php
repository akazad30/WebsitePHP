...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($result)>0){
        ...
        $tempreg = "INSERT INTO temp_teacher(fn,ln,email,password,dob,designation) VALUES ('$firstname','$lastname','$email','$pass','$dob','$designation')";
        $conn->query($tempreg);
        ...
        <div class="row">
            <div class="login_form_area">
                ...
                <div class="col-md-6 login_form">
                    <form method="post" action="registration_teacher.php" data-toggle="validator" role="form">
                        <div class="login_panel panel panel-default">
                            <div class="heading">
                                <h4>Registration Here (Teacher)</h4>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="" class="control-label">Designation</label><br>
